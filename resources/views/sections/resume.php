    ...
    <div class="container">
        ...
        <ul class="timeline">
            ...
            <li>
                <article>
                    <h3>Director</h3>
                    <p class="company">Third Rock Design S.L. <i class="fa fa-circle"></i>
                        <span>June 2003 - October 2006</span></p>
                    <p>
                        Ran a small company specialising in Real Estate software and websites as well as online retail
                        solutions. Sold a proprietary subscription-based client-side application for
